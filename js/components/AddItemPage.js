...
var AddItemPage = React.createClass({
    mixins: [Navigation],
    getInitialState() {
        return {title: "", listKey: this.props.params.listKey, items: [], item_name: "", item_url: ""};
    },
    componentWillMount() {
    ...
    onSavedItem(e) {
      if (!e) {
        this.transitionTo('listPage', {listKey: this.state.listKey});
      }
    },
    addItem(e) {
        var item = {
                        ...
                        <form className="col s12 teal">
                            <div className="row">
                                <div className="input-field col s12">
                                    ...
                                    <input onChange={this.onNameChange} value={this.state.item_name} id="title" type="text" className="validate" />
                            ...
                            <div className="row">
                                <div className="input-field col s12">
                                    ...
                                    <input onChange={this.onUrlChange} value={this.state.item_url} id="url" type="text" className="validate" />
